...
export default function Cart() {
  ...
  return (
    <>
      <article className="shadow-xl pb-[1rem] flex flex-col z-[1] justify-evenly rounded-xl px-[1.5rem] bg-white fixed md:right-[2vw] xs:right-0 lg:right-[13vw] top-[6rem]  w-[25rem] h-[15rem]">
        <h1 className="text-[1.3rem] font-bold">Card</h1>
